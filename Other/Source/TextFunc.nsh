...
!else
	...
	!macro ConfigReadUnixCall _FILE _ENTRY _RESULT
		!verbose push
		!verbose ${_TEXTFUNC_VERBOSE}
		Push `${_FILE}`
		Push `${_ENTRY}`
		${CallArtificialFunction} ConfigReadUnix_
		Pop ${_RESULT}
		!verbose pop
	!macroend

	!macro ConfigReadUnixSCall _FILE _ENTRY _RESULT
		!verbose push
		!verbose ${_TEXTFUNC_VERBOSE}
		Push `${_FILE}`
		Push `${_ENTRY}`
		${CallArtificialFunction} ConfigReadUnixS_
		Pop ${_RESULT}
		!verbose pop
	!macroend
	...
	!macro ConfigWriteUnixCall _FILE _ENTRY _VALUE _RESULT
		!verbose push
		!verbose ${_TEXTFUNC_VERBOSE}
		Push `${_FILE}`
		Push `${_ENTRY}`
		Push `${_VALUE}`
		${CallArtificialFunction} ConfigWriteUnix_
		Pop ${_RESULT}
		!verbose pop
	!macroend

	!macro ConfigWriteUnixSCall _FILE _ENTRY _VALUE _RESULT
		!verbose push
		!verbose ${_TEXTFUNC_VERBOSE}
		Push `${_FILE}`
		Push `${_ENTRY}`
		Push `${_VALUE}`
		${CallArtificialFunction} ConfigWriteUnixS_
		Pop ${_RESULT}
		!verbose pop
	!macroend
	...
	!macro ConfigReadUnixBody _TEXTFUNC_S
		!insertmacro TextFunc_BOM
		Exch $1
		Exch
		Exch $0
		...
		FileOpen $2 $0 r
		IfErrors TextFunc_ConfigReadUnix${_TEXTFUNC_S}_error
		FileReadWord $2 $5
		IntCmp $5 0xFEFF +4
		FileSeek $2 0 SET
		StrCpy $TextFunc_BOM 0
		...
		StrCpy $TextFunc_BOM FFFE
		StrLen $0 $1
		StrCmp${_TEXTFUNC_S} $0 0 TextFunc_ConfigReadUnix${_TEXTFUNC_S}_error

		TextFunc_ConfigReadUnix${_TEXTFUNC_S}_readnext:
		IntCmp $5 0xFEFF +3
		FileRead $2 $3
		Goto +2
		FileReadUTF16LE $2 $3
		IfErrors TextFunc_ConfigReadUnix${_TEXTFUNC_S}_error
		StrCpy $4 $3 $0
		StrCmp${_TEXTFUNC_S} $4 $1 0 TextFunc_ConfigReadUnix${_TEXTFUNC_S}_readnext
		StrCpy $0 $3 '' $0
		StrCpy $4 $0 1 -1
		StrCmp${_TEXTFUNC_S} $4 '$\n' 0 TextFunc_ConfigReadUnix${_TEXTFUNC_S}_close
		StrCpy $0 $0 -1
		goto -4

		TextFunc_ConfigReadUnix${_TEXTFUNC_S}_error:
		SetErrors
		StrCpy $0 ''

		TextFunc_ConfigReadUnix${_TEXTFUNC_S}_close:
		FileClose $2
	...
	!define ConfigReadUnix `!insertmacro ConfigReadUnixCall`
	!define un.ConfigReadUnix `!insertmacro ConfigReadUnixCall`

	!macro ConfigReadUnix
	!macroend

	!macro un.ConfigReadUnix
	!macroend

	!macro ConfigReadUnix_
		!verbose push
		!verbose ${_TEXTFUNC_VERBOSE}

		!insertmacro ConfigReadUnixBody ''

		!verbose pop
	!macroend

	!define ConfigReadUnixS `!insertmacro ConfigReadUnixSCall`
	!define un.ConfigReadUnixS `!insertmacro ConfigReadUnixSCall`

	!macro ConfigReadUnixS
	!macroend

	!macro un.ConfigReadUnixS
	!macroend

	!macro ConfigReadUnixS_
		!verbose push
		!verbose ${_TEXTFUNC_VERBOSE}

		!insertmacro ConfigReadUnixBody 'S'
	...
	!macro ConfigWriteUnixBody _TEXTFUNC_S
		!insertmacro TextFunc_BOM
		Exch $2
		Exch
		Exch $1
		...
		IfFileExists $0 0 TextFunc_ConfigWriteUnix${_TEXTFUNC_S}_error
		FileOpen $3 $0 a
		IfErrors TextFunc_ConfigWriteUnix${_TEXTFUNC_S}_error
		FileReadWord $3 $7
		IntCmp $7 0xFEFF +4
		FileSeek $3 0 SET
		StrCpy $TextFunc_BOM 0
		...
		StrLen $0 $1
		StrCmp${_TEXTFUNC_S} $0 0 0 TextFunc_ConfigWriteUnix${_TEXTFUNC_S}_readnext
		StrCpy $0 ''
		goto TextFunc_ConfigWriteUnix${_TEXTFUNC_S}_close

		TextFunc_ConfigWriteUnix${_TEXTFUNC_S}_readnext:
		IntCmp $7 0xFEFF +3
		FileRead $3 $4
		Goto +2
		FileReadUTF16LE $3 $4
		IfErrors TextFunc_ConfigWriteUnix${_TEXTFUNC_S}_add
		StrCpy $5 $4 $0
		StrCmp${_TEXTFUNC_S} $5 $1 0 TextFunc_ConfigWriteUnix${_TEXTFUNC_S}_readnext
		...
		StrCmp${_TEXTFUNC_S} $2 '' TextFunc_ConfigWriteUnix${_TEXTFUNC_S}_change
		StrCmp${_TEXTFUNC_S} $6 '$1$2' 0 TextFunc_ConfigWriteUnix${_TEXTFUNC_S}_change
		StrCpy $0 SAME
		goto TextFunc_ConfigWriteUnix${_TEXTFUNC_S}_close

		TextFunc_ConfigWriteUnix${_TEXTFUNC_S}_change:
		FileSeek $3 0 CUR $5
		StrLen $4 $4
		IntCmp $7 0xFEFF 0 +2 +2
		IntOp $4 $4 * 2
		...
		TextFunc_ConfigWriteUnix${_TEXTFUNC_S}_add:
		StrCmp${_TEXTFUNC_S} $2 '' 0 +3
		StrCpy $0 SAME
		goto TextFunc_ConfigWriteUnix${_TEXTFUNC_S}_close
		IntCmp $7 0xFEFF +4
		...
		TextFunc_ConfigWriteUnix${_TEXTFUNC_S}_close:
		FileClose $3
		goto TextFunc_ConfigWriteUnix${_TEXTFUNC_S}_end

		TextFunc_ConfigWriteUnix${_TEXTFUNC_S}_error:
		SetErrors
		StrCpy $0 ''

		TextFunc_ConfigWriteUnix${_TEXTFUNC_S}_end:
		Pop $7
		Pop $6
		Pop $5
		Pop $4
	...
	!define ConfigWriteUnix `!insertmacro ConfigWriteUnixCall`
	!define un.ConfigWriteUnix `!insertmacro ConfigWriteUnixCall`

	!macro ConfigWriteUnix
	!macroend

	!macro un.ConfigWriteUnix
	!macroend

	!macro ConfigWriteUnix_
		!verbose push
		!verbose ${_TEXTFUNC_VERBOSE}

		!insertmacro ConfigWriteUnixBody ''

		!verbose pop
	!macroend

	!define ConfigWriteUnixS `!insertmacro ConfigWriteUnixSCall`
	!define un.ConfigWriteUnixS `!insertmacro ConfigWriteUnixSCall`

	!macro ConfigWriteUnixS
	!macroend

	!macro un.ConfigWriteUnixS
	!macroend

	!macro ConfigWriteUnixS_
		!verbose push
		!verbose ${_TEXTFUNC_VERBOSE}

		!insertmacro ConfigWriteUnixBody 'S'
